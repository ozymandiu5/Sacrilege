package com.ozymandiu5.sacrilege.datagen;
...
public class ModItemModelProvider extends ItemModelProvider{
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, Sacrilege.MODID, existingFileHelper);
    }
    
    @Override
    protected void registerModels() {
        handheldItem(ItemInit.WHISPERING_STEEL_SWORD);
        handheldItem(ItemInit.WHISPERING_STEEL_PICKAXE);
        handheldItem(ItemInit.WHISPERING_STEEL_AXE);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Sacrilege.MODID; // Change this to your mod id
