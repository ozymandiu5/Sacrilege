...
execute if entity @s[tag=21fishbowls] run function sacrilege:altar/offerings/eastereggs/devs/21fishbowls
execute if entity @s[tag=21fishbowls] run tag @s remove 21fishbowls
...
execute if entity @s[tag=DanieloXXelo] run function sacrilege:altar/offerings/eastereggs/devs/danieloxxelo
execute if entity @s[tag=DanieloXXelo] run tag @s remove DanieloXXelo
execute if entity @s[tag=Lightigivhi] run function sacrilege:altar/offerings/eastereggs/devs/lightigivhi
execute if entity @s[tag=Lightigivhi] run tag @s remove Lightigivhi
