...
execute if entity @s[tag=undesirable] run function sacrilege:altar/offerings/sculk/undesirable
execute if entity @s[tag=undesirable] run tag @s remove undesirable
execute if entity @s[tag=mediocre] run function sacrilege:altar/offerings/sculk/mediocre
execute if entity @s[tag=mediocre] run tag @s remove mediocre
execute if entity @s[tag=prodigious] run function sacrilege:altar/offerings/sculk/prodigious
execute if entity @s[tag=prodigious] run tag @s remove prodigious
execute if entity @s[tag=consummate] run function sacrilege:altar/offerings/sculk/consummate
