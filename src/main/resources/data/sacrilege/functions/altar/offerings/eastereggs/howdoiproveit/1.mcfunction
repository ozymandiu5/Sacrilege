tellraw @s [{"text":"THEWHISPERINGMYTH","color":"dark_aqua","bold":true,"italic":true,"obfuscated":true},{"text":" whispers to you: I'M GOING TO KILL YOU...","color":"gray","bold":false,"obfuscated":false}]
