...
execute as @e[type=minecraft:armor_stand,tag=!altar] if data entity @s {ArmorItems:[{id:"sacrilege:sculk_altar"}]} run tag @s add sculk
execute as @e[type=minecraft:armor_stand,tag=!altar] if data entity @s {ArmorItems:[{id:"sacrilege:sculk_altar"}]} run tag @s add altar